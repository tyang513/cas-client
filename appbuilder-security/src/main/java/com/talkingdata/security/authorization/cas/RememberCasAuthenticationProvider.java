 ...
 * spring com.talkingdata.security jira https://jira.springsource.org/browse/SEC-2188 to address making
...
public class RememberCasAuthenticationProvider implements AuthenticationProvider, InitializingBean, MessageSourceAware {
    private Logger log = LoggerFactory.getLogger(RememberCasAuthenticationProvider.class);
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        boolean istrue = authentication instanceof UsernamePasswordAuthenticationToken
    ...
    private String getServiceUrl(Authentication authentication) {
        ...
        if (authentication.getDetails() instanceof ServiceAuthenticationDetails) {
            ...
            throw new IllegalStateException(
                    "createServiceProperties cannot be null unless Authentication.getDetails() implements ServiceAuthenticationDetails.");
        } else if (serviceProperties.getService() == null) {
            throw new IllegalStateException(
                    "createServiceProperties.getService() cannot be null unless Authentication.getDetails() implements ServiceAuthenticationDetails.");
        } else {
     ...
     * spring-com.talkingdata.security-redirect=/widget.jsp&ticket=ST-112-RiRTVZmzghHO7az5gpJF-cas
     */
