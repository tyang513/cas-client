...
import com.talkingdata.security.authorization.token.TokenAuthentication;
...
public class AppBuilderAuthenticationFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        // 当为Cas User验证时向apb/token中申请api 访问的token
        ...
        // 当为Token验证时，向session中放入user信息
        if (user == null && principal instanceof TokenAuthentication) {
